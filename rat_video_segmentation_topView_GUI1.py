...
class Window(tk.Frame):
    ...
    def client_load(self):
        ...
        def segmentation_frame(self,frame0,frame_base,maskRegion,kernel):
        ...
        ###########################
        ###########################
        # Select points to determine effective regions
        ...
        inputFig = plt.figure()
        plt.title('Select points to define effective regions')    
        ...
        for ii in range(50,length-10):
            ...
            mouseLeft, featuresLeft = segmentation_frame(self,frame0,frame_base,maskLeft,kernel)
            mouseRight, featuresRight = segmentation_frame(self,frame0,frame_base,maskRight,kernel)
