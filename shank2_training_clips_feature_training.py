...
featureFolderPath = 'C:\\PostDoctorProjects\\VideoEEGData\\Shank2_20150609\\Shank2TrainingClips\\_Feature_Exact\\'
...
joblib.dump(classifier,'mySVM_shank2.pkl')
...
activitiesNames = ['movement','rest','rotation']
