...
# the saved csv files could be used to generate training samples for SVM-HMM by combining
# Manual annotation or can be used for test samples
...
def feature_extraction_fullVideo(videoName, featureWriter, MIN_TIME_DELTA,MAX_TIME_DELTA,MHI_DURATION,THRESH_VALUE,DISPLAY=False): 
