...
#    scoreTxtName = 'C:\\PostDoctorProjects\VideoEEGData\\20150514_JD_Cam1_Cages3_4_combined\\20150514_JD_mouse4_JP.txt'    
    videoName = 'C:\\PostDoctorProjects\\VideoEEGData\\20150514_JD_Cam2_Cages1_2_combined\\JD_Cam2_20150514Cages1_2.avi'
    scoreTxtName = 'C:\\PostDoctorProjects\\VideoEEGData\\20150514_JD_Cam2_Cages1_2_combined\\20150514_JD_mouse2_JP.txt'   
...
outputVideoName = dirName+"/"+videoBaseName+"_featuresComputation.avi";
...
tic = time.time()
feature_extraction_fullVideo(videoName, scoreTxtName,startFrame, mask,featureWriter,videoOutput, MIN_TIME_DELTA,MAX_TIME_DELTA,MHI_DURATION,THRESH_VALUE,True)
toc = time.time()
