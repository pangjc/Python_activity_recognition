...
# Delete the part of reading manual scores
import numpy as np
import scipy
import cv2
...
if __name__ == '__main__':
    ...
    videoName = 'C:\\PostDoctorProjects\VideoEEGData\\20150520_Cam4_Subject_5+6_stitched\\20150520_Cam4_Subject_5+6_08-20-04_stitched.avi'
#-----------------------------------------------------
#
...
outputVideoName = dirName+"/"+videoBaseName+"_featuresComputation_features.avi";
